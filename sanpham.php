	   ...
	   $result=mysqli_query($link,$sql);
    	...
    	<div class="sanphamcon">
			...
			<div class="dienthoai">
									...
									<?php } ?>
									<a href="index.php?content=chitietsp&idsp=<?php echo $row['idsp'] ?>"><img  src="img/uploads/<?php echo $rows['hinhanh'];?>"></a><br>					
									<p><a href="index.php?content=chitietsp&idsp=<?php echo $row['idsp'] ?>" ><?php echo $rows['tensp'];?></a></p><br>
